        ...
        <div className="flex flex-wrap justify-center py-12 px-4">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-white rounded-lg shadow-xl transform transition hover:-translate-y-2 hover:shadow-2xl duration-300">
              ...
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-3 text-black">Cricket</h2>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-white rounded-lg shadow-xl transform transition hover:-translate-y-2 hover:shadow-2xl duration-300">
              ...
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-3 text-black">Football</h2>
                <p className="text-gray-700 mb-4">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-white rounded-lg shadow-xl transform transition hover:-translate-y-2 hover:shadow-2xl duration-300">
              ...
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-3 text-black">Rugby</h2>
                <p className="text-gray-700 mb-4">
